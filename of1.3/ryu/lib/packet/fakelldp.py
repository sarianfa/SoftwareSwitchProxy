...
class fakelldp(packet_base.PacketBase):
    _tlv_parsers = {}

    def __init__(self, tlvs):
        super(fakelldp, self).__init__()
        self.tlvs = tlvs
    ...
    def _parser(cls, buf):
        ...
        fakelldp_pkt = cls(tlvs)

        assert fakelldp_pkt._tlvs_len_valid()
        assert fakelldp_pkt._tlvs_valid()

        return fakelldp_pkt, None, buf
...
@fakelldp.set_tlv_type(LLDP_TLV_END)
...
@fakelldp.set_tlv_type(LLDP_TLV_CHASSIS_ID)
...
@fakelldp.set_tlv_type(LLDP_TLV_PORT_ID)
...
@fakelldp.set_tlv_type(LLDP_TLV_TTL)
...
@fakelldp.set_tlv_type(LLDP_TLV_PORT_DESCRIPTION)
...
@fakelldp.set_tlv_type(LLDP_TLV_SYSTEM_NAME)
...
@fakelldp.set_tlv_type(LLDP_TLV_SYSTEM_DESCRIPTION)
...
@fakelldp.set_tlv_type(LLDP_TLV_SYSTEM_CAPABILITIES)
...
@fakelldp.set_tlv_type(LLDP_TLV_MANAGEMENT_ADDRESS)
...
@fakelldp.set_tlv_type(LLDP_TLV_ORGANIZATIONALLY_SPECIFIC)
...
fakelldp.set_classes(fakelldp._tlv_parsers)
